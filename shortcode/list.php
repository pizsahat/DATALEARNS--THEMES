            ...
            <div class="left">
                ...
                ?>
                    <a href="<?php the_permalink() ?>">
                        <img src="<?php echo get_the_post_thumbnail_url() ?>" alt="<?php echo esc_attr(get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true) ?: 'Ilustrasi untuk ' . html_entity_decode(get_the_title())); ?>">
